...
- [not yet uploaded] **Supplementary Table 4.** List of disjunct variant-defining mutations considered for each variant combination. [\[xlsx\]](SuppTables/SuppTable4.xlsx) [\[csv\]](SuppTables/SuppTable4.csv)
